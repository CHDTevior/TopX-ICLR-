...
240 frames, at seed 42. Retrieval metrics follow \S\ref{sec:method:eval}: text-to-motion
...
of 64, 20 steps, $s{=}2$, seed 42; Table~\ref{tab:pool} gives the other pool sizes). The reference row scores the
