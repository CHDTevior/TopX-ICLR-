...
with the notes. Stripping the skeleton conditioning and the calibration together costs
\num{0.067}--\num{0.072} of R@1 and roughly doubles the FID (Table~\ref{tab:simple}); the acceleration-matching
