...
\paragraph{Optimisation.} AdamW with warm-up, cosine decay, gradient clipping and rejection of any step
whose pre-clipping gradient norm exceeds a threshold; all values are in \S\ref{sec:exp:setup}.
