...
forward pass and, when a few clips are available, by a per-rig adapter (\S\ref{sec:exp:extend}); retrieval
metrics come from a skeleton-aware evaluator (\S\ref{sec:exp:setup}).
...
Truebones rig used in \S\ref{sec:exp:extend}.
