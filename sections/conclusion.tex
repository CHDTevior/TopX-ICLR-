...
trajectory the rig plays directly; a rig outside the library is served by the same forward pass, and a
low-rank adapter on roughly ten clips brings its two output channels into agreement. The library is
animal-only, and the extension study covers four rigs.
