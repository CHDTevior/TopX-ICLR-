...
\paragraph{Arithmetic.} Generating and scoring the epoch-100 pilot end to end with TF32 matrix multiplication
...
This is that flattening-and-padding construction on our data and objective, not an implementation of MDM,
T2M-GPT, MoMask or MMM. Its group weights are the control's, measured on the control's model; the gradient-share
and acceleration diagnostics of that calibration describe that model and not this one.
