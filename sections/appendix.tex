...
the two arms above, the remaining \num{0.029}--\num{0.034} is what the geodesic and direction biases and the
...
improve monotonically with size; the \num{303}M model at epoch 200 is about a point of R@1 below its epoch-289 checkpoint in
Table~\ref{tab:main} (\num{0.857} against \num{0.867}), so most of its gain over the pilot comes from
