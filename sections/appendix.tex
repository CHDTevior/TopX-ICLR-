...
structural features, and fixes every group weight at one. Frozen protocol, pools of 64; the simplified arm was
sampled with TF32 matrix multiplication and the full recipe in fp32, which App.~\ref{app:controls} measures at
\num{0.0003} of R@1.}\label{tab:simple}
\begin{tabular}{@{}lcccc@{}}
\toprule
...
\paragraph{Shared source animations.} The annotation set exports one source animation several times,
so a motion can appear under more than one clip; inside a retrieval pool the acceptance sets group those
exports by their caption text, which the exports share. On the \num{512} validation clips over
