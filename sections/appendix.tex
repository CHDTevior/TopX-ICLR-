...
\begin{table}[h]
\centering\small
\caption{One ingredient at a time, on the \num{36}M pilot. Same clips, cut, split, captions, rest-pose
demonstration, batch, learning rate, schedule and budget in every row; frozen protocol, pools of 64, 20 Euler
steps, guidance 2, seed 42. The last row is the adapted
baseline of App.~\ref{app:flat}, which carries \num{5}\% more parameters than the full
recipe.}\label{tab:simple}
