...
Table~\ref{tab:lora} are sampled with seed 7; the zero-training arm and the adapters start from the epoch-214
snapshot of the backbone. The learning rate
...
released code. Two capabilities separate this task from its neighbours. A caption is not what
...
Both models train in bf16 on 8 H200 GPUs, \num{578} optimiser steps per epoch at the global batch of
Table~\ref{tab:hparams}; the optimiser and schedule settings are those of that table.
