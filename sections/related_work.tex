...
kinematics; it embeds natural-language \emph{descriptions} of the joints with LLM2Vec where AnyTop embeds
cleaned joint names with T5; and it normalises every (rig, joint, channel) cell with its own statistics, so that
