...
generates, without text, across the skeletons of the Truebones zoo~\citep{truebones}.
Text-conditioned animal motion has been approached from a fixed 35-joint
SMAL template by OmniMotionGPT~\citep{yang2024omnimotiongpt}, from a shared human--animal topology
by X-MoGen~\citep{wang2025xmogen} (115 species), on a unified 30-joint skeleton by AniMo~\citep{wang2025animo}, whose AniMo4D
...
UniMate~\citep{mou2026unimate}. \method{} is text-conditioned; it
